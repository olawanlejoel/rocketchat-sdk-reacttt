...
const App = () => {
    ...
    const loadStreamMessages = async (rid) => {
        return sdk.stream('room-messages', rid, (args) => {
            setMessages((messages) => {
                messages.set(args._id, args);
                return new Map(messages);
            });
    ...
    const sendChatMessage = async (e, myRoomID) => {
                        ...
                        {selectedRoom ? (
                            <div className="messages-col">
                                ...
                                <div className="form">
                                    ...
                                    ></textarea>
                                    <a
                                        onClick={(e) => sendChatMessage(e, selectedRoom)}
